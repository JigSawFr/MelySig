...
public class ActualitesNew extends javax.swing.JFrame implements Observer {
    ...
    private void initComponents() {
        ...
        maListeDerniersUtilisateurs.setModel(new javax.swing.AbstractListModel() {
            String[] strings = { "TheRainb0w", "Coonax", "Poook", "Ezio", "Edge", "Psycho", "Paco", "Blondie", "Shinn", "Panzer", " " };
            public int getSize() { return strings.length; }
            public Object getElementAt(int i) { return strings[i]; }
        });
        ...
        maListeDerniersParcours.setModel(new javax.swing.AbstractListModel() {
            String[] strings = { "Musées de Nancy", "FastFood de Nancy", "Commerces de Nancy", "Marché de Noël de Strasboug", "Fleuristes de Thionville", "Garagistes de Metz", "Plombiers de Vandoeuvre", "Stations Essences de Tomblaine", "Boites de nuit de Lorraine", "Patisseries du Luxembourg", "Magasins d'informatiques d'Elange" };
            public int getSize() { return strings.length; }
            public Object getElementAt(int i) { return strings[i]; }
        });
